<div class="flex flex-row justify-center items-center gap-4">
  <figure class="flex flex-col justify-center items-center p-8 text-center bg-white rounded-lg border-b border-gray-200 md:border-e dark:bg-gray-800 dark:border-gray-700 w-full h-full">
  ...
  <figure class="flex flex-col justify-center items-center p-8 text-center bg-white rounded-lg border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 w-full h-full">
    <blockquote class="mx-auto mb-4 max-w-2xl text-gray-500 dark:text-gray-400">
  ...
  <figure class="flex flex-col justify-center items-center p-8 text-center bg-white rounded-lg border-b border-gray-200 md:border-b-0 md:border-e dark:bg-gray-800 dark:border-gray-700 w-full h-full">
    <blockquote class="mx-auto mb-4 max-w-2xl text-gray-500 dark:text-gray-400">
  ...
  <figure class="flex flex-col justify-center items-center p-8 text-center bg-white rounded-lg border-gray-200 md:rounded-br-lg dark:bg-gray-800 dark:border-gray-700 w-full h-full">
    <blockquote class="mx-auto mb-4 max-w-2xl text-gray-500 dark:text-gray-400">
